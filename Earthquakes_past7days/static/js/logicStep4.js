...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
    ...
    L.geoJson(data, {
        // We turn each feature into a circleMarker on the map.  Turn each feature into a circleMarker on the map.
        ...
        onEachFeature: function(feature, layer) {
            layer.bindPopup("Manitude: " + feature.properties.mag + "<br>Location: " + feature.properties.place);
        }
    }).addTo(earthquakes)

        //  add the earthquate layer to our map.
